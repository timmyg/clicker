...
module.exports.checkControlCenterEvents = RavenLambdaWrapper.handler(
  Raven,
  async event => {
...
module.exports.runEndToEndTests = RavenLambdaWrapper.handler(
  Raven,
  async event => {
    ...
    await fetch(
      `https://circleci.com/api/v2/project/github/teamclicker/clicker/pipeline`,
      {
...
module.exports.logChannelChange = RavenLambdaWrapper.handler(
  Raven,
  async event => {
...
module.exports.airtableRemoveExpired = RavenLambdaWrapper.handler(
  Raven,
  async event => {
    const tableNames = [
      "Control Center v1",
