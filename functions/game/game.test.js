const {
  getInProgressAndCompletedGames,
  buildStatus,
  transformGame,
  transformSIUrl
} = require("./game");
...
describe("transformGame", () => {
  test("ncaa football", () => {
    ...
    expect(result.home.logo).toBe(
      "https://static.sprtactn.co/teamlogos/ncaaf/100/bay.png"
    );
    ...
    expect(result.away.logo).toBe(
      "https://static.sprtactn.co/teamlogos/ncaaf/100/wvu.png"
    );
