      ...
      <div class="features-split-inner section-inner">
        <div class="split-wrap invert-mobile">
          ...
          >
            ...
            >
              <img
                src="/images/landing/illustrations/undraw-app-2.svg"
                alt="Mobile phone drawing"
              />
            </div>
          </div>
          <div
          ...
          >
            <div class="split-item-content center-content-mobile">
              <h3 class="mt-0 mb-16">😌 Sports TV <em>Nirvana</em></h3>
              <p class="m-0">
                <b>Control Center</b> manages all your TVs behind the scenes, so
