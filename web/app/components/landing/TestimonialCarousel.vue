<template>
  <section
    class="testimonial section center-content"
    :class="[
  ...
  >
    <div class="container-xs">
      ...
      >
        ...
        <c-carousel
          class="tiles-wrap reveal-scale-up"
          :class="[pushLeft && 'push-left']"
          autorotate
          :autorotate-timing="7000"
        >
            ...
            <div class="tiles-item-inner">
              <div class="testimonial-item-header mb-16">
                <div class="testimonial-item-image">
                  <img
                    src="/images/testimonial-image-01.png"
                    alt="Testimonial 01"
                    width="56"
                    height="56"
                  />
          ...
          <c-carousel-item class="tiles-item">
            <div class="tiles-item-inner">
              <div class="testimonial-item-header mb-16">
                <div class="testimonial-item-image">
                  <img
                    src="/images/testimonial-image-02.png"
                    alt="Testimonial 02"
                    width="56"
                    height="56"
                  />
          ...
          <c-carousel-item class="tiles-item">
            <div class="tiles-item-inner">
              <div class="testimonial-item-header mb-16">
                <div class="testimonial-item-image">
                  <img
                    src="/images/testimonial-image-03.png"
                    alt="Testimonial 03"
                    width="56"
                    height="56"
                  />
