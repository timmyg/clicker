...
export default {
    ...
    computed: {
        activeAnnouncements() {
            return this.allAnnouncements.filter(a => moment().isBetween(a.start, a.end));
        }
    }
};
</script>
...
.text {
    border: 5px solid;
    border-image-source: url(https://clicker-brand.s3.amazonaws.com/checkerboard.png);
    border-image-slice: 15 45;
