        ...
        <section class="container">
          ...
          <ol type="a">
            <li>
              ...
              Clicker, Inc.'s web site for personal, non-commercial transitory viewing only. This is the grant of a
          ...
          <ol type="a">
            <li>
              The materials on Clicker, Inc.'s web site are provided "as is". Clicker, Inc. makes no warranties,
              expressed or implied, and hereby disclaims and negates all other warranties, including without limitation,
              implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement
              of intellectual property or other violation of rights. Further, Clicker, Inc. does not warrant or make any
          ...
          <p>
            The materials appearing on Clicker, Inc.'s web site could include technical, typographical, or photographic
            errors. Clicker, Inc. does not warrant that any of the materials on its web site are accurate, complete, or
            current. Clicker, Inc. may make changes to the materials contained on its web site at any time without
            notice. Clicker, Inc. does not, however, make any commitment to update the materials.
          </p>

          <h3>6. Links</h3>

          <p>
            Clicker, Inc. has not reviewed all of the sites linked to its Internet web site and is not responsible for
            the contents of any such linked site. The inclusion of any link does not imply endorsement by Clicker, Inc.
          ...
          <p>
            Clicker, Inc. may revise these terms of use for its web site at any time without notice. By using this web
          ...
          <p>
            Any claim relating to Clicker, Inc.'s web site shall be governed by the laws of the State of Delaware
