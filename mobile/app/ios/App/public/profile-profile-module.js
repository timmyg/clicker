...
/***/ "./src/app/profile/logging-in.component.ts":
/*!*************************************************!*\
  !*** ./src/app/profile/logging-in.component.ts ***!
  \*************************************************/
/*! exports provided: LoggingInComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoggingInComponent", function() { return LoggingInComponent; });
...
/* harmony import */ var _state_user_user_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../state/user/user.actions */ "./src/app/state/user/user.actions.ts");
...
var LoggingInComponent = /** @class */ (function () {
    ...
    LoggingInComponent.prototype.ngOnInit = function () {
        ...
        this.route.fragment.subscribe(function (fragment) {
            if (fragment) {
                _this.processLogin(fragment);
            }
        });
    };
    LoggingInComponent.prototype.processLogin = function (fragment) {
        var _this = this;
        var context = this;
        auth.parseHash({ hash: fragment }, function (err, authResult) { return __awaiter(_this, void 0, void 0, function () {
            var jwt_1, newUserId_1;
            var _this = this;
    ...
    LoggingInComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            template: '<ion-row class="ion-justify-content-center" margin-top><ion-spinner name="crescent"></ion-spinner></ion-row>',
        }),
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.loginModal.present()];
...
/***/ "./src/app/profile/reservation/reservation.component.html":
/*!****************************************************************!*\
  !*** ./src/app/profile/reservation/reservation.component.html ***!
  \****************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Byb2ZpbGUvcmVzZXJ2YXRpb24vcmVzZXJ2YXRpb24uY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/profile/reservation/reservation.component.ts":
/*!**************************************************************!*\
  !*** ./src/app/profile/reservation/reservation.component.ts ***!
  \**************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_state_reservation_reservation_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/state/reservation/reservation.model */ "./src/app/state/reservation/reservation.model.ts");
...
var ReservationComponent = /** @class */ (function () {
    ...
    ReservationComponent.prototype.setTimeLeftRefresher = function () {
        var endTime = moment__WEBPACK_IMPORTED_MODULE_2__(this.reservation.end);
        var duration = moment__WEBPACK_IMPORTED_MODULE_2__["duration"](endTime.diff(moment__WEBPACK_IMPORTED_MODULE_2__()));
